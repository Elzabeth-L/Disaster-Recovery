...
output "cluster_version" { value = try(module.eks_platform[0].cluster_version, null) }
output "ecr_repository_url" { value = try(module.eks_platform[0].ecr_repository_url, null) }
...
output "addon_versions" { value = try(module.eks_platform[0].addon_versions, {}) }
