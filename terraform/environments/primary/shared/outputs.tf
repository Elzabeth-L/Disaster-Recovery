...
output "vpc_id" {
  description = "Primary shared VPC ID."
  value       = module.network.vpc_id
}

output "vpc_cidr_block" {
  description = "Primary shared VPC IPv4 CIDR."
...
output "s3_gateway_endpoint_id" {
  description = "Primary S3 gateway endpoint ID."
  value       = module.network.s3_gateway_endpoint_id
}

output "name_prefix" {
  description = "Approved primary shared naming prefix."
...
output "nat_public_ip" {
  description = "Public NAT address when egress is enabled."
